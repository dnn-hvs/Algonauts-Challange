# A script to get results for vgg16
...
python3 generate_features.py --image_dir  $parameterA --save_dir  "./feats"  --net vgg16 --load_model $parameterD --exp vgg16_foveate
...
#python3 generate_features.py --image_dir  $parameterA --save_dir  "./feats"  --net vgg16 --load_model $parameterC --exp vgg16_no_foveate
...
python3 generate_features.py --image_dir  $parameterB --save_dir  "./feats"  --net vgg16 --load_model $parameterD --exp vgg16_foveate
...
#python3 generate_features.py --image_dir  $parameterB --save_dir  "./feats"  --net vgg16 --load_model $parameterC --exp vgg16_no_foveate
