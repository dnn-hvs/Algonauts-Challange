...
python3 generate_features.py --image_dir  $parameterA --save_dir  "./feats"  --net vgg1 --load_model $parameterD 
...
python3 generate_features.py --image_dir  $parameterA --save_dir  "./feats"  --net vgg2 --load_model $parameterC 
...
python3 generate_features.py --image_dir  $parameterB --save_dir  "./feats"  --net vgg1 --load_model $parameterD 
...
python3 generate_features.py --image_dir  $parameterB --save_dir  "./feats"  --net vgg2 --load_model $parameterC 
